...
class Employee02Controller extends Controller
{
    /**
     * @Route("New02/Employee", name="Employee_New02")
     */
    public function NewEmployee02Action(Request $request)
    {
		//$employee_type = new employee_type02();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            *}
            */
            //return $this->render('Succes/new/Employee_Succes02.html.twig', array('Employee' => $Employees,));
        }
        
        return $this->render('Employee/NewEmployee02.html.twig', array(
           'form' => $form->createView(),
        ));

    }
    /**
     * @Route("Multiple02/New/EmployeePersonalinfo", name="Employee_Personalinformation02")
     */
    public function MultipleNewEmployee02Action(Request $request)
    {
		$Employees = new Employees02();		
		$form = $this->createForm(Employee02::class,$Employees);
        ...
        return $this->render('Employee/Employeeinfo02.html.twig', array(
           'form' => $form->createView(),
        ));

    }
    /**
     * @Route("Multiple02/New/EmployeesAdress/{idemployee}", name="Employees_Adress02")
     */
    public function Employeeadress02Action(Request $request,$idemployee)
    {
		
           		
            $adress = new Adresses02();
            $form = $this->createForm(Adress02::class,$adress);
         ...
         return $this->render('Employee/Employeeadress02.html.twig', array(
           'form' => $form->createView(),
        ));

    }
    /**
     * @Route("Edit02/Employee/{idemployee}", name="Employee_editNew02")
     */
    public function EditEmployee02Action(Request $request, $idemployee)
    {
		//$employee_type = new employee_type();
		        $emplo = new Employees02();
                $Adresses = new Adresses02();
               $em = $this->getDoctrine()->getManager();
               
               $emplo = $em->getRepository(Employees02::class)->find($idemployee);
                $adres = $em->getRepository(Adresses02::class)->findOneBy(array('employeeid'=> $idemployee));  		
        ...
        return $this->render('Employee/EditNewemployee02.html.twig', array(
           'form' => $form->createView(),"employeeid"=>$idemployee
        ));

    }
    /**
     * @Route("Multiple02/Edit/Employee_Personalinfo/{idemployee}", name="Employees_editPersonalinfo02")
     */
    public function editPersonalinfo302Action(Request $request,$idemployee)
    {
		...
		$form = $this->createForm(Employee02::class,$emplo);
                $form->handleRequest($request);
            ...
            *}
            */
           return $this->redirectToRoute('Employees_editAdress02', ['idemployee'=>$emplo->getId()]);
        }
		
        return $this->render('Employee/EditEmployeeinfo02.html.twig', array(
           'form' => $form->createView(),
        ));
    ...
    /**
     * @Route("Multiple02/Edit/EmployeesAdress/{idemployee}", name="Employees_editAdress02")
     */
    public function NewEmployee302Action(Request $request,$idemployee)
    {
		
		
        $em = $this->getDoctrine()->getManager();
               
        $adres = $em->getRepository(Adresses02::class)->findOneBy(['employeeid'=>$idemployee]);  		
        ...
        return $this->render('Employee/EditEmployeeadress02.html.twig', array('employeeid'=>$idemployee,
           'form' => $form->createView(),
        ));
