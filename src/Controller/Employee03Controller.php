...
class Employee03Controller extends Controller
{
    /**
     * @Route("New03/Employee", name="Employee_New03")
     */
    public function NewEmployee03Action(Request $request)
    {
		//$employee_type = new employee_type03();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            *}
            */
            //return $this->render('Succes/new/Employee_Succes03.html.twig', array('Employee' => $Employees,));
        }
        
        return $this->render('Employee/NewEmployee03.html.twig', array(
           'form' => $form->createView(),
        ));

    }
    /**
     * @Route("Multiple03/New/EmployeePersonalinfo", name="Employee_Personalinformation03")
     */
    public function MultipleNewEmployee03Action(Request $request)
    {
		$Employees = new Employees03();		
		$form = $this->createForm(Employee03::class,$Employees);
        ...
        return $this->render('Employee/Employeeinfo03.html.twig', array(
           'form' => $form->createView(),
        ));

    }
    /**
     * @Route("Multiple03/New/EmployeesAdress/{idemployee}", name="Employees_Adress03")
     */
    public function Employeeadress03Action(Request $request,$idemployee)
    {
		
           		
            $adress = new Adresses03();
            $form = $this->createForm(Adress03::class,$adress);
         ...
         return $this->render('Employee/Employeeadress03.html.twig', array(
           'form' => $form->createView(),
        ));

    }
    /**
     * @Route("Edit03/Employee/{idemployee}", name="Employee_editNew03")
     */
    public function EditEmployee03Action(Request $request, $idemployee)
    {
		//$employee_type = new employee_type();
               ...
               $emplo = $em->getRepository(Employees03::class)->find($idemployee);
                $adres = $em->getRepository(Adresses03::class)->findOneBy(array('employeeid'=> $idemployee));  		
        ...
        return $this->render('Employee/EditNewemployee03.html.twig', array(
           'form' => $form->createView(),"employeeid"=>$idemployee
        ));

    }
    /**
     * @Route("Multiple03/Edit/Employee_Personalinfo/{idemployee}", name="Employees_editPersonalinfo03")
     */
    public function editPersonalinfo303Action(Request $request,$idemployee)
    {
		...
		$form = $this->createForm(Employee03::class,$emplo);
                $form->handleRequest($request);
            ...
            *}
            */
           return $this->redirectToRoute('Employees_editAdress03', ['idemployee'=>$emplo->getId()]);
        }
		
        return $this->render('Employee/EditEmployeeinfo03.html.twig', array(
           'form' => $form->createView(),
        ));
    ...
    /**
     * @Route("Multiple03/Edit/EmployeesAdress/{idemployee}", name="Employees_editAdress03")
     */
    public function NewEmployee303Action(Request $request,$idemployee)
    {
		
		
        $em = $this->getDoctrine()->getManager();
               
        $adres = $em->getRepository(Adresses03::class)->findOneBy(['employeeid'=>$idemployee]);  		
        ...
        return $this->render('Employee/EditEmployeeadress03.html.twig', array('employeeid'=>$idemployee,
           'form' => $form->createView(),
        ));
